...
@section('title')
    <title>Admin Daskrimti - Bidang</title>
@endsection
...
@section('content')
    ...
    <section class="section">
                ...
                <div class="table-responsive">
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            @foreach ($dataBidang as $dw)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $dw->nama_bidang }}</td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                @include('admin_main.bidang.update')
                            @endforeach
        ...
        @include('admin_main.bidang.insert')
        ...
        $(document).on('click', '.btnDelete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '/bidangDestroy/' + id;
