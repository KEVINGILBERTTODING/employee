...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Riwayat Transaksi</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Riwayat Transaksi</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Riwayat Permohonan</h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Riwayat Permohonan</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    Table Daftar Riwayat Permohonan
                </h5>
                <div class="d-flex justify-content-end">
                    <a href="{{ route('reportHistoryPermohonan', Crypt::encrypt($userId)) }}" class="btn btn-primary"><i
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tablePermintaan').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('getPermintaanHistory') }}/' + userId,
                order: [
                    [1, 'desc']
                ],
                columns: [{
