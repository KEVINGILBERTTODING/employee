...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Filter</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Filter</title>
    @endif
@endsection
                    ...
                    <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu active">
                            <li class="submenu-item  ">
                                <a href="{{ route('indexSemuaPermintaanAdmin') }}" class="submenu-link">Semua Permintaan</a>

                            </li>
                            <li class="submenu-item  ">
                                <a href="" class="submenu-link">Permintaan Proses</a>
                            </li>

                            <li class="submenu-item  ">
                                <a href="" class="submenu-link">Permintaan Valid</a>

                            </li>
                            <li class="submenu-item  ">
                                <a href="" class="submenu-link">Tidak Valid</a>
                            </li>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Filter Daftar Permohonan</h3>
                <p>Periode {{ $dateFrom }} s/d {{ $dateEnd }}</p>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Filter Permohonan</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-end">
                    <button style="margin-right: 10px;" class="btn btn-info mr-2" data-bs-toggle="modal"
                        data-bs-target="#modal_filter"><i class="fa fa-filter"></i> Filter
                    </button>

                    <a class="btn btn-success"
                        href="{{ route('reportFilterTransactions', ['dateFrom' => $dateFrom, 'dateEnd' => $dateEnd, 'status' => $status]) }}"><i
                            class="fa fa-print"></i> Download PDF
                    </a>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tablePermintaan').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('filterTransactionsAdmin') }}/' + dateFrom + '/' + dateEnd + '/' + status,
                order: [
                    [1, 'desc']
                ],
                columns: [{
