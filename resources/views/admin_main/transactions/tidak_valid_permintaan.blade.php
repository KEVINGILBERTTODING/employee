...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Tidak Validd Permohonan</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Tidak Validd Permohonan</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Permohonan Tidak Valid</h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Permohonan Tidak Valid</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    Table Daftar Permohonan Tidak Valid
                </h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#tablePermintaan').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('getPermintaanByStatusAdmin/0') }}',
                order: [
                    [1, 'desc']
                ],
                columns: [{
