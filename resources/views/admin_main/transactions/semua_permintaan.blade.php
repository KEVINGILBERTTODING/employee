...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Seluruh Permohonan</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Seluruh Permohonan</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Seluruh Permohonan</h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Seluruh
                            Permohonan</li>
                    </ol>
                </nav>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#tablePermintaan').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('getPermintaanByStatusAdmin/3') }}',
                order: [
                    [1, 'desc']
                ],
                columns: [{
