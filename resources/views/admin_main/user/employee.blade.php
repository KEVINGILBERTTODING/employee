...
@section('title')
    <title>Admin Daskrimti - Pegawai</title>
@endsection
...
@section('content')
    ...
    <section class="section">
                ...
                <div class="table-responsive">
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            @foreach ($dataEmployee as $dw)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $dw->npp }}</td>
                                    <td><a href="{{ route('users/history', $dw->id) }}">{{ $dw->name }}</a>
                                    </td>
                                    <td>
                                        @if ($dw->nama_bidang != null)
                                            {{ $dw->nama_bidang }}
                                        @else
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button style="margin-right: 10px" class="btn btn-warning btn-sm"
                                                data-bs-toggle="modal"
                                                data-bs-target="#modal_update_{{ $dw->id }}"><i
                                                    class="fa-regular fa-pen-to-square"></i></button>
                                            <button data-id="{{ $dw->id }}"
                                                class="btn btn-danger btnDelete btn-sm"><i
                                ...
                                @include('admin_main.user.update')
                            @endforeach
        ...
        @include('admin_main.user.insert')
