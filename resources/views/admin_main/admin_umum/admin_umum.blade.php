...
@section('title')
    <title>Admin Daskrimti - Admin Umum</title>
@endsection
...
@section('content')
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Admin Umum</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
                        ...
                        <tbody>
                            ...
                            @foreach ($dataAdminUmum as $dw)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button style="margin-right: 10px" class="btn btn-sm btn-warning btn-sm"
                                                data-bs-toggle="modal"
                                                data-bs-target="#modal_update_{{ $dw->id }}"><i
                                                    class="fa-regular fa-pen-to-square"></i></button>
                                            <button data-id="{{ $dw->id }}"
                                                class="btn btn-danger btn-sm btn-sm btnDelete"><i
                                ...
                                @include('admin_main.admin_umum.update')
                            @endforeach
        ...
        @include('admin_main.admin_umum.insert')
