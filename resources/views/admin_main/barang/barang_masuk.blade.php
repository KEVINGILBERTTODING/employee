...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Barang Masuk</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Barang Masuk</title>
    @endif
@endsection
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item  active has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="{{ route('adminBarang') }}" class="submenu-link">Data Barang</a>

                            </li>
                            <li class="submenu-item active">
                                <a href="{{ route('adminAdminUmum') }}" class="submenu-link">Barang Masuk</a>
                            </li>

                            <li class="submenu-item">
                                <a href="{{ route('adminAdminUmum') }}" class="submenu-link">Barang Keluar</a>
                            </li>
...
@section('content')
    ...
    <section class="section">
        ...
        @include('admin_main.barang.modal.modal_filter_data_barang')
