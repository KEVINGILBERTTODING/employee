...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Filter Barang Masuk</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Filter Barang Masuk</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Filter Barang Masuk</h3>
                <p class="text">Periode {{ $dateFrom }} s/d {{ $dateEnd }}</p>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Filter Barang Masuk</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('reportDataBarangMasuk', ['dateFrom' => $dateFrom, 'dateEnd' => $dateEnd]) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tableBarang').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('fetchFilterBarang') }}/' + dateFrom + '/' + dateEnd,
                order: [
                    [1, 'desc']
                ],
