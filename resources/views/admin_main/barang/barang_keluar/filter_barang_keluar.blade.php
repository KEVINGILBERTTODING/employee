...
@section('title')
    @if (session('role') == 'admin_daskrimti')
        <title>Admin Daskrimti - Filter Barang Keluar</title>
    @elseif (session('role') == 'admin_umum')
        <title>Admin Umum - Filter Barang Keluar</title>
    @endif
@endsection
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Filter Barang Keluar</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('reportDataBarangKeluar', ['dateFrom' => $dateFrom, 'dateEnd' => $dateEnd]) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tableBarang').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('fetchFilterBarangKeluar') }}/' + dateFrom + '/' + dateEnd,
                order: [
                    [1, 'desc']
                ],
