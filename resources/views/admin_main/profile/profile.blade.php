...
@section('content')
    ...
    <section class="section">
                        ...
                        <div class="card-body py-4 px-4">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-xl">
                                    <img id="profilePhoto"
                                        src="{{ asset('data/profile_photo/' . $dataAdmin['profile_photo']) }}"
                                        alt="Face 1">
                                </div>
                                <div class="ms-3 name">
                                    <h5 class="font-bold">{{ $dataAdmin['name'] }}</h5>
                                    <h6 class="text-muted mb-0">{{ $dataAdmin['npp'] }}</h6>
                                    <button class="btn btn-sm mt-2 btn-warning" data-bs-target="#modal_update_password"
                                        data-bs-toggle="modal">Ubah Kata
                                        Sandi</button>
                                </div>
                            </div>
                        </div>
        ...
        {{-- include modal update password --}}
        @include('admin_main.profile.update_password')

        {{-- include modal update profile photo --}}
        @include('admin_main.profile.upload_profile_photo')
